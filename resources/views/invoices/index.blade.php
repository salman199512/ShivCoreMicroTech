                ...
                <div class="flex items-start justify-between mb-8">
                    <div>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <a href="{{ asset('invoice.xlsx') }}" download class="text-sm text-emerald-600 hover:text-emerald-800 font-black uppercase tracking-widest flex items-center gap-2 transition">
