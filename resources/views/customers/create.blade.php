                ...
                <form action="{{ route('customers.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="email" name="email_2" id="email_2" class="block w-full border-slate-200 rounded-xl shadow-sm focus:ring-indigo-500 focus:border-indigo-500 font-bold text-slate-700 h-14" placeholder="client+sec1@example.com">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="email" name="email_3" id="email_3" class="block w-full border-slate-200 rounded-xl shadow-sm focus:ring-indigo-500 focus:border-indigo-500 font-bold text-slate-700 h-14" placeholder="client+sec2@example.com">
                        </div>
                    </div>
